...
class UpdateHandle:
    ...
    def updateDir(self, path, parentPath):
        ...
        parentFile= pfile.Pfile(path,parentName)
    ...
    def updateFile(self,file,parent):

        edtranslator= pfhandle.PFhandle(None,None,file.getTransArg()) #pf handle for encoding/decoding translation
